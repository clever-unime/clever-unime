 ...
 */
public class SOSDescribeSensorCommand extends CleverCommand{
    ...
    public Options getOptions() {
        ...
        options.addOption("f",true,"The file that contains describeSensor Request");
    ...
    String returnResponse;
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "SOSAgent", "describeSensor", params, commandLine.hasOption("xml"));
                System.out.println("\n---------describeSensor-----------");
