 ...
 */
public class SOSGetObservationCommand extends CleverCommand{
    ...
    public Options getOptions() {
        ...
        options.addOption("f",true,"The file that contains getObservation Request");
    ...
    String returnResponse;
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "SOSAgent", "getObservation", params, commandLine.hasOption("xml"));
                System.out.println("\n---------getObservation-----------");
