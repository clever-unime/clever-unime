 ...
 * @author roberto
 */
public class DestroyVmcommand extends CleverCommand{
 ...
 public void exec( final CommandLine commandLine )
  { 
    try
    {
      ...
      ClusterManagerAdministrationTools.instance().execAdminCommand( this, target, "VirtualizationManagerAgent", "destroyVm", params, commandLine.hasOption( "xml" ) );
  ...
  public void handleMessage(Object response){
    System.out.println("VM successfully destroyed");
  }

   
    public void handleMessageError(CleverException response) {
        System.out.println("Failed to destroy VM"); 
