 ...
 */
public class SASCancelSubscriptionCommand extends CleverCommand{
    ...
    public void exec(CommandLine commandLine) {
        ...
        try {
            ...
            if (!target.equals("")) {
                returnResponse=(String)ClusterManagerAdministrationTools.instance().execSyncAdminCommand(this, target, "SASAgent", "cancelSubscription", params, commandLine.hasOption("xml"));
