 ...
 * @author roberto
 */
public class UnregisterVmcommand extends CleverCommand {
 ...
 public void exec( final CommandLine commandLine )
  { 
    try
    {
      ...
      ClusterManagerAdministrationTools.instance().execAdminCommand( this, target, "VirtualizationManagerAgent", "unregisterVm", params, commandLine.hasOption( "xml" ) );
  ...
  public void handleMessage(Object response){
    ...
    public void handleMessageError(CleverException response) {
        System.out.println("Failed to unregister VM"); 
